...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "badiyo — Home cleaning, on demand" },
      { name: "twitter:description", content: "Book trusted home cleaning services in Latur with badiyo. Fast, reliable experts — just a tap away." },
